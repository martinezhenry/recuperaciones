...
<div class="typography">
                                    ...
                                    <button title="Cancelar" id= "cancelar" onclick="if (tabActivo.value == \'gestiones\'){ $(\'#AgregarActivo\').val(\'0\'); cargarGestiones(cuentaActual.value, clienteActual.value, carteraActual.value, usuarioGestorActual.value, tipoCuentaActual.value); } else if (tabActivo.value == \'abonos\'){ $(\'#AgregarActivo\').val(\'0\'); cargarAbonos(cuentaActual.value); } else { $(\'#AgregarActivo\').val(\'0\'); cargarGestiones(cuentaActual.value, clienteActual.value, carteraActual.value, usuarioGestorActual.value, tipoCuentaActual.value); }" hidden type="button"><img width="30px" heigth="30px" src="img/black-cancel.png"/></button>
