...
<div style="background: rgba(255,255,255,.9);" class="sky-tabs sky-tabs-pos-top-left sky-tabs-anim-slide-top sky-tabs-response-to-stack">
							...
							<label class="pequeño" for="sky-tab1-1"><span><span>{d_tab1}</span></span></label>
							...
							<ul>
								<li style="height: 50px; overflow:visible; background: inherit;" class="sky-tab-content-1">
                                    ...
                                    <div class="row">
                                    <div>
                                        <button disabled id="btn_validar" style="margin-left: -3%; float: left; margin-top: 1%;" type="button"><img title="Validar" width="25px" heigth="25px" src="img/ico/validar.ico"/></button>
                                       <!-- <button disabled id="btn_ver_datos" style="margin-left: -6%; float: left; margin-top: 1%;" type="button" ><img title="Ver Datos" width="25px" heigth="25px" src="img/ico/ver.ico"/></button> -->
                                        <a disabled id="btn_ver_datos" style="margin-left: -6%; float: left; margin-top: 1%;" target="_blank" href="http://www.ivss.gob.ve"><img title="Ver Datos" width="25px" heigth="25px" src="img/ico/ver.ico"/></a>
                                        </div>
                                        ...
                                        <section class="col col-3">
                                            ...
                                            <label class="input" >
                                                <input type="text" placeholder="{dt1_ci}" onkeypress="checkKey(this.value, event);" id="cedulaDeudor" style="width: 83%;" name="cedulaDeudor" /></label>
                            ...
                            <fieldset>
                                <section class="col col-8">
                                        ...
                                        <label class="textarea">
                                            ...
                                            <textarea tabindex="11" style="font-size: 11px; line-height: 1" id="observaciones" name = "observaciones" rows="4" readonly="readonly" placeholder="{g_obs}"></textarea>
                                        </label>
