...
require_once($_SESSION['ROOT_PATH']."/controlador/c_direcciones.php");
										...
										<div class = "row">
											<div id="tabla_dir">';
												...
												<table  style="font-size: 11px;" cellpadding="0" cellspacing="0" border="0" class="display dataTable" id="direcciones-Tabla">
													<thead>
														<tr>
															<th width="300px">{dirt_tab1}</th>
															<th width="20px">{dirt_tab2}</th>
														</tr>
													</thead>
													<tbody>';
                                          ...
                                          <form class="sky-form">
						<button name="Enviar" type="button" onclick="mostrarAdvertenciaDirecciones()" disabled  class="button" id="direccion_guardar">{dirb_tab1}</button>
                                                <button type="button" class="button" onclick="agregarDireccion(personaActual.value);" id="btnAgregarDireccion">{dirb_tab2}</button>
						<button type="button" class="button" onclick="v_direccion_activarEdicion();" id="direccion_edit_reset">{dirb_tab3}</button>
                                                                </form>                      
...
function v_direccion_enviarDatos() {
	...
	$.ajax({
		  type: "POST",
		  url: 'expediente/contenedor/direcciones.php',
		  data: parametros,
