...
(function (global, undefined) {
	...
	Alertify = function () {
		...
		dialogs = {
			...
			input   : "<input placeholder=\"Mensaje\" type=\"text\" class=\"alertify-text\" id=\"alertify-text\">",
                        //Propio
                        fecha   : "<input placeholder=\"Fecha\" type=\"date\" class=\"alertify-text\" id=\"alertify-date\">",
                        hora    : "<input placeholder=\"Hora\" type=\"time\" class=\"alertify-text\" id=\"alertify-hora\">",
                        //
		...
		_alertify = {
			...
			addListeners : function (fn) {
				var btnReset  = $("alertify-resetFocus"),
				    ...
				    input     = $("alertify-text")   || undefined,
                                    fecha     = $("alertify-date")   || undefined,
                                    hora     = $("alertify-hora")   || undefined,
				...
				ok = function (event) {
					...
					if (typeof input !== "undefined") val = input.value;
                                        if (typeof fecha !== "undefined") val2 = fecha.value;
                                        if (typeof hora !== "undefined") valhora = hora.value;                                      
                                        if (typeof fn === "function") fn(true, val, val2, valhora);
                                         
                                       // if (typeof fn === "function") fn(true, true, val2);
				};
			...
			build : function (item) {
				...
				html += dialogs.message.replace("{{message}}", message);
                                ...
                                //Propio
				if (type === "prompt"){ html += dialogs.input; html += dialogs.fecha; html += dialogs.hora;}
